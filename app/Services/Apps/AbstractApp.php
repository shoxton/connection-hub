...
abstract class AbstractApp implements AppInterface {
     ...
     *
     * @var \App\Services\Apps\AbstractUser|null
     */
    protected $user;
    ...
    public function withCredentials($credentials) {
        $this->accessToken = Arr::get($credentials, 'access_token', '');
        $this->refreshToken = Arr::get($credentials, 'refresh_token', '');
        $this->expiresIn = Arr::get($credentials, 'expires_in', '');
    }
    ...
    /**
     * Get validation rules for the authorization request.
     *
     * @return array
     */
